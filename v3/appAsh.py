...
from yolov7 import object_detection
...
def generate_frames():
    camera = object_detection.LoadStreams("https://172.16.3.123:8080/video")  # Replace with your IP camera URL
    while True:
        frame = object_detection.detect(camera)  # Apply object detection
        yield (b'--frame\r\n'
...
def video_feed():
    return Response(generate_frames('172.16.3.123:8080'), mimetype='multipart/x-mixed-replace; boundary=frame')
